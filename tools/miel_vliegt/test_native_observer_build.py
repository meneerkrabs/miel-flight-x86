...
class NativeObserverBuildTest(unittest.TestCase):
    ...
    def test_dinput_proxy_bounds_typed_ddraw7_startup_forwarding(self):
        ...
        self.assertIn("#define D3D7_ZFORMAT_HELPER_CODE_CHUNKS 4", source)
        self.assertIn("EnumZBufferFormats-callback-code ", source)
        self.assertIn("EnumZBufferFormats-callback-helper ", source)
        self.assertIn("entry[9] == 0xE8", source)
        self.assertIn("d3d7_trace_zformat_callback((void *)callback)", source)
